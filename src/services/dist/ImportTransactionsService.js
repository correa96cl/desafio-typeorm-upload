...
var ImportTransactionsService = /** @class */ (function () {
    ...
    ImportTransactionsService.prototype.execute = function (filePath) {
        return __awaiter(this, void 0, Promise, function () {
            var transactionRepository, categoriesRepository, contactsReadStream, parsers, parseCSV, transactions, categories, existenCategories, existenCategoriesTitles, addCategoryTitles, newCategories, finalCategories, createdTransactions;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        existenCategories = _a.sent();
                        existenCategoriesTitles = existenCategories.map(function (category) { return category.title; });
                        addCategoryTitles = categories.filter(function (category) { return !existenCategoriesTitles.includes(category); }).filter(function (value, index, self) { return self.indexOf(value) === index; });
                    ...
                    case 3:
                        _a.sent();
                        finalCategories = __spreadArrays(newCategories, existenCategories);
                        createdTransactions = transactionRepository.create(transactions.map(function (transaction) { return ({ title: transaction.title,
                            type: transaction.type,
                            value: transaction.value, category: finalCategories.find(function (category) { return category.title === transaction.category; })
                        }); }));
